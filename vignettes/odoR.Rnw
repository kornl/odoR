...
<<fig.width=12, fig.height=12, out.width="\\linewidth", out.height="\\linewidth", fig.align="center">>=
library(odoR)
file <- system.file("extdata", "Effect_Opening_Door-25.01.2024.csv", package = "odoR")
dat <- read.odor(file)
plot.odor(dat)
@
